...
<template>
  <div
    v-if="showModal"
    class="fixed h-[100vh] w-full top-0 bottom-0 left-0 right-0 flex flex-row flex-nowrap items-center z-[999]"
  >
    <div
      class="fixed blur h-[inherit] w-full bg-[rgba(255,255,255,.8)]"
    ...
    ></div>
    <div class="relative bg-white mx-auto h-auto shadow-xl overflow-hidden divide-y" :style="containerStyle">
